...
<br>
<br>
Hi There, I’m Arvind Janardhanan, a seasoned cybersecurity leader with over 15 years of experience in enterprise security, specializing in secure software development, DevSecOps, and enterprise security architecture. Throughout my career, I’ve had the privilege of architecting security solutions at scale—solutions that are designed with security first mindset while enabling development teams to innovate securely and confidently.
While I haven’t directly contributed to OWASP or open source projects, I’ve been a long-time and ardent consumer of OWASP’s resources. From threat modeling to OWASP Top 10s to secure coding practices, OWASP has been a cornerstone in shaping the security posture of the organizations I’ve served. I see this candidacy as an opportunity to give back—by bringing the voice of OWASP’s largest consumers, enterprise security teams, closer to the community that builds the tools and standards we rely on every day.
My work has focused on designing and delivering scalable application security programs, integrating comprehensive security toolchains across SAST, SCA, MAST, IaC, DAST, secrets detection, API, and cloud security. I’ve led initiatives in vulnerability management, posture management, and secure-by-default capability delivery—always with an eye toward enterprise adoption and real-world constraints.
What drives me is the opportunity to bridge the gap between cutting-edge security research and practical, actionable guidance. I believe that security standards must be both aspirational and achievable. They must empower teams of all sizes—not just the well-resourced—to build secure software. That’s where I believe OWASP can lead, and where I hope to contribute.
My leadership philosophy is rooted in empowerment, mentorship, and inclusive collaboration. I’ve built and led diverse, global teams of engineers, architects, and consultants, and I’ve seen firsthand how the best security solutions emerge when different perspectives and experiences are brought together. I want to bring that same spirit to OWASP.
